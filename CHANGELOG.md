...
- Added a query param `custom_config` to the `/<resource-type>/config/upload` routes which allows marking a resource as
  ...
  by the frontend.
- Added caching functionality to speed up listing of export files generated by Sparv and Karp.
...
[unreleased]: https://github.com/spraakbanken/mink-backend/compare/v3.0.0...dev/
[3.0.0]: https://github.com/spraakbanken/mink-backend/releases/tag/v3.0.0
