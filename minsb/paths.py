...
def get_corpora_dir(domain="local", user="", ui=None, mkdir=False):
...
def get_corpus_dir(domain="local", user="", corpus_id="", ui=None, mkdir=False):
    """Get dir for given corpus."""
    send_mkdir = mkdir if domain == "local" else False
    corpora_dir = get_corpora_dir(domain, user, ui, send_mkdir)
...
def get_export_dir(domain="local", user="", corpus_id="", ui=None, mkdir=False):
    """Get export dir for given corpus."""
    send_mkdir = mkdir if domain == "local" else False
    corpus_dir = get_corpus_dir(domain, user, corpus_id, ui, send_mkdir)
...
def get_work_dir(domain="local", user="", corpus_id="", ui=None, mkdir=False):
...
def get_source_dir(domain="local", user="", corpus_id="", ui=None, mkdir=False):
